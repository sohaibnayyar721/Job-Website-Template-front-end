...
function Job03(props) {
  ...
  let [SingleJobId, setSingleJobId] = useState('')
  
  // function getSingleJobDetails(id) {
  //   setSingleJobId(id)
  // }
  const navigate = useNavigate();
  function getSingleJobDetails(id) {
    // setSingleJobId(id)
    // props.singleJobId(id)
              ...
              <div className="swiper-wrapper style-1">
                <div className="swiper-slide">
                  <TabPanel className="row animation-tab job-tab-item">
                    {getFeaturedJobData.map((idx) => (
                      <div key={idx._id} className="col-lg-6 ">
                        <div className="features-job"
                        onClick={()=>{getSingleJobDetails(idx._id)}}>
