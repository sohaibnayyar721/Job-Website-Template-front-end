                    ...
                    <div className="row">
                        <div className="col-lg-2 col-md-4">
                            <div className="footer-logo">
                                <img src={require('../../assets/custom Images/logo.png')} alt="images" />
                            </div>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-2 col-md-6 col-6">
                            <div className="footer-cl-2">
                                ...
                                <ul className="navigation-menu-footer">
                                    <li> <Link to="find-jobs-list.html">Home</Link> </li>
                                    <li> <Link to="find-jobs-list.html">Jobs</Link> </li>
                                    <li> <Link to="find-jobs-list.html">About us</Link> </li>
                        ...
                        <div className="col-lg-2 col-md-4 col-6">
                            <div className="footer-cl-3">
                                ...
                                <ul className="navigation-menu-footer">
                                    <li> <Link to="dashboard.html">Privacy Policy</Link> </li>
                                    <li> <Link to="sample-cv.html">Cookie Policy</Link> </li>
                                    <li> <Link to="candidate-list-sidebar.html">Terms & Condition</Link> </li>
                        ...
                        <div className="col-lg-2 col-md-4 col-6">
                            <div className="footer-cl-4">
                                ...
                                <ul className="navigation-menu-footer">
                                    <li> <Link to="find-jobs-list.html">001-1234-8888</Link> </li>
                                    <li> <Link to="find-jobs-list.html">abc@gmail.com</Link> </li>
                                    <div className="ft-icon"> <i className="icon-map-pin"></i> 101 E 129th St, East Chicago, IN 46312, US</div>
                                    {/* <li> <Link to="employers-list.html">Employer Listing</Link> </li>
